...
`supabase/analytics-dashboard-domus-salud.sql`

Esto crea la tabla `analytics_events`, que registra visitas, clics y eventos públicos/paciente, separados de la actividad interna de administradores y profesionales. No almacena RUT, diagnósticos ni información clínica.
