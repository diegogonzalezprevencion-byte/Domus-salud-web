...
## Ajuste 2026-09-11: ficha clínica y filtros en administrador

- En Administrador > Pacientes > Ver ficha clínica, ahora se muestra la ficha clínica general completa con el mismo bloque de antecedentes que ve el profesional.
- Se agregó un panel superior para filtrar el historial por Tipo de atención y Tipo de visita/procedimiento.
- El historial muestra solo los episodios/evoluciones que coinciden con los filtros seleccionados.
- No requiere cambios adicionales en Supabase si ya se ejecutó la centralización y la actualización de episodios.
