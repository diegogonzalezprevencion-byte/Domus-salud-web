...
├─ index.html
├─ assets/
│  ├─ logo-domus-salud.png
│  ├─ logo-domus-salud-symbol.png
│  ├─ hero-homecare.svg
│  ├─ hero-caregivers.svg
│  ├─ hero-clinical.svg
│  ├─ hero-rehab.svg
...
- Logo corporativo incorporado en encabezado, footer y archivos del sitio.
- Paleta visual ajustada a azul corporativo y verde del logo.
- Títulos del slider reducidos aproximadamente en un tercio.
- Imágenes del slider reemplazadas por recursos locales para evitar diapositivas sin imagen visible.
- Se eliminó la banda con los pasos 01 a 04 solicitada.
