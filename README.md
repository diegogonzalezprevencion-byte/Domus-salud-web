...
## Actas IA (septiembre 2026)

Consulta `INSTRUCCIONES-ACTAS-IA.md`. Ejecutar únicamente `supabase/2026-09-18-actas-ia.sql`, configurar `OPENAI_API_KEY` en el servidor Vercel y desplegar. Disponible en Video llamadas → detalle → Acta de reunión. Requiere consentimiento separado, transcripción detenida y revisión/aprobación humana. Descarga DOCX real o impresión/guardado PDF.
