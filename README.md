...
Para que las métricas, testimonios, perfiles de administrador, equipo directivo e imágenes se sincronicen entre distintos computadores o navegadores, se debe conectar una base de datos externa, por ejemplo Supabase.
