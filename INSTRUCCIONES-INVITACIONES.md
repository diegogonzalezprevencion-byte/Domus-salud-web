...
**Correos de invitados:** confirma que cada integrante que vaya a ser invitado tenga un email válido en `video_members`. Ahora el formulario impide crear una reunión con invitados sin email. ACTUALIZACIÓN 21-09-2026: los organizadores también reciben un correo de confirmación tras ejecutar `2026-09-21-fase1-video.sql`; consulta `INSTALACION-FASE1-VIDEOLLAMADAS.md`.
