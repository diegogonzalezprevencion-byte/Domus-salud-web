...
evolutionForm?.addEventListener('submit', (event) => {
  ...
  renderProfessionalPatients();
  renderPatientsAdmin();
  if (message) message.textContent = evolution.clinicalRecordUpdated
    ? 'Evolución guardada correctamente. La ficha clínica general fue actualizada y el cambio quedó registrado en el historial.'
