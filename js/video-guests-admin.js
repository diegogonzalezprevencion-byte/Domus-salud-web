...
(() => {
  ...
  function render(record = null) {
    ...
    if (!busy) {
      ...
      else if (active) label('Existe un enlace activo creado antes de esta actualización. Revócalo y genera uno nuevo para que quede siempre disponible en el resumen.');
  ...
  async function refresh() {
    ...
    try {
      ...
      record = result.link; link = result.shareLink || null; render(record);
