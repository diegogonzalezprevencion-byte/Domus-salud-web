...
(function (root) {
  ...
  function makeDocx({title,date,participants,sections,sourceSegments}) {
    ...
    const doc=`<?xml version="1.0" encoding="UTF-8" standalone="yes"?>`+
      ...
      paragraph(Number(sourceSegments)>0 ? `Revisión de administración · Fuente: ${sourceSegments} fragmentos transcritos.` : 'Revisión de administración · Acta manual sin transcripción automática.')+
