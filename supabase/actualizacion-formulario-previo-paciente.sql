...
-- Actualización obligatoria si el formulario del paciente no registra en Supabase.
...
values (
  'default',
  'Completa todos los campos antes del inicio del servicio para que el equipo de Domus Salud pueda preparar mejor la atención. Si algún dato no aplica, escribe “No aplica”.',
  '[]'::jsonb,
  true
)
...
-- =====================================================
-- LECTURA SEGURA POR TOKEN PARA TRASPASAR ANTECEDENTES
-- AL FORMULARIO DEL PROFESIONAL
-- =====================================================
